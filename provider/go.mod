module github.com/MaterializeInc/pulumi-fivetran/provider
...
require (
	github.com/fivetran/terraform-provider-fivetran v1.1.1
...
require (
	...
	github.com/fivetran/go-fivetran v0.7.12 // indirect
